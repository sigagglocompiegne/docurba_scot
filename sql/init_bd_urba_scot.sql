...
SELECT ('arc' || ltrim(to_char(id,'999')))  as id, insee, commune, sup_ha, src_geom, src_date, date_sai, date_maj, geom
FROM m_urbanisme_reg.geo_scot_surf_conso_arc
UNION
SELECT ('ccba' || ltrim(to_char(id,'999'))) as id, insee, commune, sup_ha, src_geom, src_date, date_sai, date_maj, geom
FROM m_urbanisme_reg.geo_scot_surf_conso_ccba
UNION
SELECT ('lach' || ltrim(to_char(id,'999'))) as id, insee, commune, sup_ha, src_geom, src_date, date_sai, date_maj, geom
...
-- ####################################################### TRIGGER - suivi_conso - calcul_sup_ha #############################################################
...
-- ####################################################### TRIGGER - suivi_conso - insee #############################################################


/* ***** Attention, à l'échelle cadastrale, problème de calage de geomètrie du referentiel osm, propre topoliquement en revanche *****
...
-- ####################################################### TRIGGER - hyp_surf_a_conso_arc - calcul_sup_ha #############################################################
