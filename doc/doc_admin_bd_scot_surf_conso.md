...
En plus des zones d'habitat et d'activités, les secteurs d'équipements publics y compris sportifs (terrain) ou de loisirs (parc) ont été intégrés dans les surfaces consommées au titre des espaces naturels et agricoles.
